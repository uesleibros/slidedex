...
class EvolutionProcessor:
	...
	def evolve_pokemon(self, owner_id: str, pokemon_id: int, new_species_id: int) -> Dict:
		return self.executor.evolve(owner_id, pokemon_id, new_species_id)
