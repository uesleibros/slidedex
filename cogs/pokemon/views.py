...
class PokemonInfoLayout(discord.ui.LayoutView):
	def __init__(self, current_pokemon: Dict, current_index: int, total_pages: int, tk: Toolkit, user_timezone: str):
		super().__init__()
	...
	def _cache_pokemon_data(self):
		...
		self._caught_at = TimezoneHelper.format_datetime(p['caught_at'], self.user_timezone)
