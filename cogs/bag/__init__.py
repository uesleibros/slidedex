...
class Bag(commands.Cog, name="Mochila"):
    ...
    def _get_needed_files(self, bag_items: List[Dict]) -> List[discord.File]:
        categories: Set[str] = {item['category'] for item in bag_items}
        return [
            discord.File(self.CATEGORY_ICONS[cat], f"{cat}.png") 
