...
ITEM_EMOJIS = {
	...
	"great-ball": PokeBallSystem.get_ball_emoji("great-ball"),
	"ultra-ball": PokeBallSystem.get_ball_emoji("ultra-ball"),
	"master-ball": PokeBallSystem.get_ball_emoji("master-ball"),
	"safari-ball": PokeBallSystem.get_ball_emoji("safari-ball"),
	"net-ball": PokeBallSystem.get_ball_emoji("net-ball"),
	"nest-ball": PokeBallSystem.get_ball_emoji("nest-ball"),
	"repeat-ball": PokeBallSystem.get_ball_emoji("repeat-ball"),
	"timer-ball": PokeBallSystem.get_ball_emoji("timer-ball"),
	"luxury-ball": PokeBallSystem.get_ball_emoji("luxury-ball"),
	"dive-ball": PokeBallSystem.get_ball_emoji("dive-ball"),
	"premier-ball": PokeBallSystem.get_ball_emoji("premier-ball"),
