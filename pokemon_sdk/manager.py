...
from .constants import NATURES, REGIONS_GENERATION, VERSION_GROUPS, EVOLUTION_STONES
...
class PokemonManager:
	...
	async def give_item(
		...
		new_quantity = self.tk.add_item(user_id, item_id, quantity, await self.get_item_category(item_id))
